...
export class Init1774091758761 implements MigrationInterface {
    name = 'Init1774091758761';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "inventories" ADD CONSTRAINT "FK_2afef596f4433616d852f67f4f2" FOREIGN KEY ("ownerUid") REFERENCES "users"("uid") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "inventories" DROP CONSTRAINT "FK_2afef596f4433616d852f67f4f2"`,
        );
